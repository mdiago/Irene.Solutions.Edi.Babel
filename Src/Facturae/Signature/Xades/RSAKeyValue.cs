...
namespace Irene.Solutions.Edi.Babel.Facturae.Signature.Xades
{
    ...
    /// </summary>
    public class RSAKeyValue : Element
    {
        ...
        public string Modulus
        {
            get
            {
                return _Modulus.Content;
            }
            set
            {
                _Modulus.Content = value;
            }
        }

        /// <summary>
        /// Exponente (cifrado^Exponent) mod Modulus = descifrado
        /// </summary>
        public string Exponent
        {
            get
            {
                return _Exponent.Content;
            }
            set
            {
                _Exponent.Content = value;
            }
        }
        ...
        public RSAKeyValue()
            : base("ds:RSAKeyValue")
        {
            _Modulus = AddElement(new Element("ds:Modulus"));
            _Exponent = AddElement(new Element("ds:Exponent"));
        }
    }
}
