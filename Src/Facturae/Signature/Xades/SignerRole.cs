...
namespace Irene.Solutions.Edi.Babel.Facturae.Signature.Xades
{
    ...
    /// </summary>
    public class SignerRole : Element
    {

        /// <summary>
        /// Constructor.
        /// </summary>
        public SignerRole() : base("etsi:SignerRole")
        {
            Element ClaimedRole = new Element("etsi:ClaimedRole", "emisor");/* Emisor - Tercero - Receptor */
            Element ClaimedRoles = new Element("etsi:ClaimedRoles");
            ClaimedRoles.AddElement(ClaimedRole);
            AddElement(ClaimedRoles);
        }
    }
}
