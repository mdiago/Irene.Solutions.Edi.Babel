...
namespace Irene.Solutions.Edi.Babel.Facturae.Signature.Xades
{
    ...
    public class ReferenceContent : Element
    {
        ...
        /// Constructor.
        /// </summary>
        /// <param name="IdObjRef">Id. del objeto.</param>
        public ReferenceContent(string IdObjRef) : base("ds:Reference")
        {
            AddAttribute("Id", "Reference-ID-" + IdObjRef);
            AddAttribute("URI", "");
            Element Transforms = new Element("ds:Transforms");
            Element Transform = new Element("ds:Transform");
            Transform.AddAttribute("Algorithm", Signer.DefaultReferenceContentTransform);
