...
namespace Irene.Solutions.Edi.Babel.Facturae.Signature.Xades
{
    ...
    /// Valor de la firma.
    /// </summary>
    public class SignatureValue : Element
    {

        /// <summary>
        /// Constructor.
        /// </summary>
        /// <param name="idSignatureValue">Id. Firma.</param>
        public SignatureValue(string idSignatureValue)
            : base("ds:SignatureValue")
        {
            AddAttribute("Id", "SignatureValue" + idSignatureValue);
        }

        /// <summary>
        /// Constructor.
        /// </summary>
        /// <param name="content">Valor del elemento.</param>
        /// <param name="idSignatureValue">Id. Firma.</param>
        public SignatureValue(string content, string idSignatureValue)
            : base("ds:SignatureValue", content)
        {
            AddAttribute("Id", "SignatureValue" + idSignatureValue);
        }
    }
