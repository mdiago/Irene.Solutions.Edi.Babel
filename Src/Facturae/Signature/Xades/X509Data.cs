...
namespace Irene.Solutions.Edi.Babel.Facturae.Signature.Xades
{
    ...
    /// </summary>
    public class X509Data : Element
    {

        /// <summary>
        /// Información del certificado.
        /// </summary>
        Element _X509Certificate;
        ...
        public string X509Certificate
        {
            get
            {
                return _X509Certificate.Content;
            }
            set
            {
                _X509Certificate.Content = value;
            }
        }
        ...
        /// Constructor.
        /// </summary>
        public X509Data() : base("ds:X509Data")
        {
            _X509Certificate = AddElement(new Element("ds:X509Certificate"));
        }
    }
}
