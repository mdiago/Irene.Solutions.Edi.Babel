...
namespace Irene.Solutions.Edi.Babel.Facturae
{
    ...
    public class RegistrationDataType
    {
        ...
        /// <summary>
        /// Representación textual de la instancia de RegistrationDataType.
        /// </summary>
        /// <returns>Representación textual de la instancia de RegistrationDataType.</returns>
        public override string ToString()
        {
            return $"{RegisterOfCompaniesLocation}, {Book}," +
                $" {Sheet}, {Folio}, {Section}, {Volume}";
        }
