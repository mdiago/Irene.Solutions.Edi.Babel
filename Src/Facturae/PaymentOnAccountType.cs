...
namespace Irene.Solutions.Edi.Babel.Facturae
{
    ...
    public class PaymentOnAccountType
    {
        ...
        public DateTime PaymentOnAccountDate { get; set; }

        /// <summary>
        /// Importe de cada anticipo. Hasta ocho decimales.
        /// </summary>
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public double PaymentOnAccountAmount { get; set; }
        ...
        /// <summary>
        /// Representación textual de la instancia de PaymentOnAccountType.
        /// </summary>
        /// <returns>Representación textual de la instancia de PaymentOnAccountType.</returns>
        public override string ToString()
        {
            return $"{PaymentOnAccountDate}, {PaymentOnAccountAmount}";
        }
