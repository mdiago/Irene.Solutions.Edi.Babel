...
namespace Irene.Solutions.Edi.Babel.Facturae
{
    ...
    public class PGPDataType
    {
        ...
        [XmlChoiceIdentifier("PGPKeyElementName")]
        public object[] PGPKey { get; set; }

        /// <summary>
        /// Nombre de los elmentos PGP.
        /// </summary>
        [XmlElement("PGPKeyElementName")]
        [XmlIgnore()]
        public PGPKeyElementName[] PGPKeyElementName { get; set; }
        ...
        /// <summary>
        /// Representación textual de la instancia de PGPDataType.
        /// </summary>
        /// <returns>Representación textual de la instancia de PGPDataType.</returns>
        public override string ToString()
        {
            return $"{PGPKeyElementName}";
        }
