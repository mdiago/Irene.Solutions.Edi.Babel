...
namespace Irene.Solutions.Edi.Babel.Facturae
{
    ...
    public class X509IssuerSerialType
    {
        ...
        /// <summary>
        /// Representación textual de la instancia de X509IssuerSerialType.
        /// </summary>
        /// <returns>Representación textual de la instancia de X509IssuerSerialType.</returns>
        public override string ToString()
        {
            return $"{X509IssuerName}, {X509SerialNumber}";
        }
