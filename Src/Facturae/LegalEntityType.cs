...
namespace Irene.Solutions.Edi.Babel.Facturae
{
    ...
    public class LegalEntityType
    {
        ...
        /// </summary>
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public RegistrationDataType RegistrationData { get; set; }
        ...
        /// <summary>
        /// Representación textual de la instancia de LegalEntityType.
        /// </summary>
        /// <returns>Representación textual de la instancia de LegalEntityType.</returns>
