...
namespace Irene.Solutions.Edi.Babel.Facturae
{
    ...
    public class AccountType
    {
        ...
        /// </summary>
        [XmlIgnore()]
        public AccountChoiceType AccountElementName { get; set; }
        ...
        /// Dirección.
        /// </summary>
        [XmlElement("BranchInSpainAddress", typeof(AddressType), Form = XmlSchemaForm.Unqualified)]
        [XmlElement("OverseasBranchAddress", typeof(OverseasAddressType), Form = XmlSchemaForm.Unqualified)]
