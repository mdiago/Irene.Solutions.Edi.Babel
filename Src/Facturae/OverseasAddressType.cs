...
namespace Irene.Solutions.Edi.Babel.Facturae
{
    ...
    /// <summary>
    /// Dirección en el extranjero (fuera de España).
    /// </summary>
    [Serializable()]
    public class OverseasAddressType
    {
        ...
        /// </summary>
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public CountryType CountryCode { get; set; }
        ...
        /// <summary>
        /// Representación textual de la instancia de OverseasAddressType.
        /// </summary>
        /// <returns>Representación textual de la instancia de OverseasAddressType.</returns>
        public override string ToString()
        {
            return $"{CountryCode}, {PostCodeAndTown}, {Address}";
        }
