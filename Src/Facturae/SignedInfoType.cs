...
namespace Irene.Solutions.Edi.Babel.Facturae
{
    ...
    /// <summary>
    /// Información de método de firma.
    /// </summary>
    [Serializable()]
    ...
    public class SignedInfoType
    {
        ...
        /// <summary>
        /// Método de canonicalización del xml.
        /// </summary>
        ...
        /// <summary>
        /// Representación textual de la instancia de SignedInfoType.
        /// </summary>
        /// <returns>Representación textual de la instancia de SignedInfoType.</returns>
        public override string ToString()
        {
            return $"{CanonicalizationMethod}, {SignatureMethod}";
        }
